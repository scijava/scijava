...
public class TestConvertImages extends AbstractOpTest{
	...
	public void testBitToBit() {
		...
		Nil<RandomAccessibleInterval<BitType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.bit").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.bit").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint2() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<Unsigned2BitType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint2").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint2").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint4() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<Unsigned4BitType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint4").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint4").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToInt8() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<ByteType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.int8").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.int8").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint8() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<UnsignedByteType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint8").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint8").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint12() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<Unsigned12BitType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint12").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint12").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToInt16() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<ShortType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.int16").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.int16").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint16() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<UnsignedShortType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint16").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint16").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToInt32() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<IntType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.int32").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.int32").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint32() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<UnsignedIntType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint32").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint32").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToInt64() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<LongType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.int64").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.int64").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint64() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<UnsignedLongType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint64").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint64").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToUint128() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<Unsigned128BitType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.uint128").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.uint128").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToFloat32() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<FloatType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.float32").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.float32").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToCfloat32() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<ComplexFloatType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.cfloat32").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.cfloat32").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToFloat64() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<DoubleType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.float64").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.float64").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
	...
	public void testBitToCfloat64() {
		...
		final var img = ops.binary("create.img") //
				...
				.apply();
		ops.unary("image.fill").input(b).output(img).compute();
		Nil<RandomAccessibleInterval<ComplexDoubleType>> nil = new Nil<>() {};
		// Create the converted image
		var converted = ops.unary("convert.cfloat64").input(img).outType(nil).apply();
		var cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
    ...
    b.set(false);
		ops.unary("image.fill").input(b).output(img).compute();
		converted = ops.unary("convert.cfloat64").input(img).outType(nil).apply();
		cursor = Views.iterable(converted).cursor();
		while(cursor.hasNext()) {
