...
public class Transforms<T, R extends RealType<R>, N extends NumericType<N>, Y extends Type<Y>, F extends RandomAccessibleInterval<T>, E extends EuclideanSpace> {
	...
	@OpField(names = "transform.addDimensionView", params = "input, result", params = "x")
	public final Function<RandomAccessible<T>, MixedTransformView<T>> addDimensionView = Views::addDimension;

	@OpField(names = "transform.addDimensionView", params = "input, min, max, result", params = "x")
	...
	@OpField(names = "transform.collapseView", params = "input, result", priority = Priority.LOW, params = "x")
	public final Function<RandomAccessible<T>, CompositeView<T, ? extends GenericComposite<T>>> collapseViewRA = Views::collapse;

	@OpField(names = "transform.collapseView", params = "input, result", params = "x")
	...
	@OpField(names = "transform.collapseRealView", params = "input, numChannels, result", params = "x")
	...
	@OpField(names = "transform.collapseRealView", params = "input, result", params = "x")
	...
	@OpField(names = "transform.collapseNumericView", params = "input, numChannels, result", params = "x")
	...
	@OpField(names = "transform.collapseNumericView", params = "input, result", params = "x")
	...
	@OpField(names = "transform.concatenateView", params = "concatenationAxis, inputs, result", params = "x")
	...
	@OpField(names = "transform.concatenateView", params = "concatenationAxis, stackAccess, inputs, result", params = "x")
	...
	@OpField(names = "transform.dropSingletonDimensionsView", params = "input, result", params = "x")
	...
	@OpField(names = "transform.extendValueView", params = "input, value, result", params = "x")
	...
	@OpField(names = "transform.extendZeroView", params = "input, result", params = "x")
	...
	@OpField(names = "transform.permuteCoordinatesInverseView", params = "input, permutation, dimension, result", params = "x")
	...
	@OpField(names = "transform.permuteCoordinatesView", params = "input, permutation, result", params = "x")
	public final BiFunction<RandomAccessibleInterval<T>, int[], IntervalView<T>> permuteCoordinates = Views::permuteCoordinates;

	@OpField(names = "transform.permuteCoordinatesView", params = "input, permutation, dimension, result", params = "x")
	...
	@OpField(names = "transform.stackView", params = "stackAccessMode, inputs, result", params = "x")
