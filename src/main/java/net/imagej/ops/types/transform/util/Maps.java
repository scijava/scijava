...
public class Maps {
	...
	public interface Functions {
		...
		public interface RAIs {
			...
			public static <I, O extends Type<O>> Function<RandomAccessibleInterval<I>, RandomAccessibleInterval<O>> liftBoth(
			...
			public static <I extends NativeType<I>, O extends NativeType<O>> Function<RandomAccessibleInterval<I>, RandomAccessibleInterval<O>> liftBothNativesView(
					final Function<I, O> function) {
				return in -> {
					O outType = function.apply(Util.getTypeFromInterval(in));
	...
	public interface Computers {
		...
		public interface RAIs {
			...
			public static <I, O> org.scijava.ops.function.Computers.Arity1<RandomAccessibleInterval<I>, RandomAccessibleInterval<O>> liftBoth(
					final org.scijava.ops.function.Computers.Arity1<I, O> computer) {
			...
			public static <I1, I2, O> org.scijava.ops.function.Computers.Arity2<RandomAccessibleInterval<I1>, RandomAccessibleInterval<I2>, RandomAccessibleInterval<O>> liftBoth(
					final org.scijava.ops.function.Computers.Arity2<I1, I2, O> computer) {
