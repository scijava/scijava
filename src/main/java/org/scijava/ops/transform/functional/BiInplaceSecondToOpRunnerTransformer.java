...
public class BiInplaceSecondToOpRunnerTransformer implements FunctionalTypeTransformer {
...
//		Type[] outTypes = ref.getOutTypes();
		return OpRunners.Inplaces.toRunner((BiInplaceSecond) src);
	}

	@Override
	public Class<?> srcClass() {
		return BiInplaceSecond.class;
	}
