...
public class Inplace5FirstToOpRunnerTransformer implements FunctionalTypeTransformer {
...
//		Type[] outTypes = ref.getOutTypes();
		return OpRunners.Inplaces.toRunner((Inplace5First) src);
	}

	@Override
	public Class<?> srcClass() {
		return Inplace5First.class;
	}
