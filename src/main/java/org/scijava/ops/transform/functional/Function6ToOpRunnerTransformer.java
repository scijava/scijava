...
public class Function6ToOpRunnerTransformer implements FunctionalTypeTransformer {
	...
	public Object transform(OpService opService, OpRef ref, Object src) {
		return OpRunners.Functions.toRunner((Function6) src);
	}

	@Override
	public Class<?> srcClass() {
		return Function6.class;
	}
