...
public class Dilations<T extends RealType<T> & Comparable<T>, R extends RealType<R>> {
	...
	@OpField(names = "morphology.dilate", params = "source, strels, numThreads, result", params = "x")
	public final Functions.Arity3<Img<R>, List<Shape>, Integer, Img<R>> dilateImgList = Dilation::dilate;

	@OpField(names = "morphology.dilate", params = "source, strel, numThreads, result", params = "x")
	public final Functions.Arity3<Img<R>, Shape, Integer, Img<R>> dilateImgSingle = Dilation::dilate;

	@OpField(names = "morphology.dilate", params = "source, strels, minValue, numThreads, result", params = "x")
	public final Functions.Arity4<Img<T>, List<Shape>, T, Integer, Img<T>> dilateImgListMinValue = Dilation::dilate;

	@OpField(names = "morphology.dilate", params = "source, strel, minValue, numThreads, result", params = "x")
	public final Functions.Arity4<Img<T>, Shape, T, Integer, Img<T>> dilateImgSingleMinValue = Dilation::dilate;

	@OpField(names = "morphology.dilate", params = "source, strels, numThreads, target", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, strels, minVal, numThreads, target", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, strel, numThreads, target", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, strel, minVal, numThreads, target", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, interval, strels, numThreads", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, interval, strels, minVal, numThreads", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, interval, strel, numThreads", params = "x")
	...
	@OpField(names = "morphology.dilate", params = "source, interval, strel, minVal, numThreads", params = "x")
