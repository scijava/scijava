...
public class Inplace4FirstToOpRunnerTransformer implements FunctionalTypeTransformer {
...
//		Type[] outTypes = ref.getOutTypes();
		return OpRunners.Inplaces.toRunner((Inplace4First) src);
	}

	@Override
	public Class<?> srcClass() {
		return Inplace4First.class;
	}
