 ...
 */
@FunctionalInterface
public interface Consumer13<T, U, V, W, X, Y, Z, A, B, C, D, E, F> {
	...
	/**
	 * Returns a composed {@code Consumer13} that performs, in sequence, this
	 ...
	 * @return a composed {@code Consumer13} that performs in sequence this
	 *         operation followed by the {@code after} operation
	 * @throws NullPointerException
	 *             if {@code after} is null
	 */
	default Consumer13<T, U, V, W, X, Y, Z, A, B, C, D, E, F> andThen(
			Consumer13<? super T, ? super U, ? super V, ? super W, ? super X, ? super Y, ? super Z, ? super A, ? super B, ? super C, ? super D, ? super E, ? super F> after) {
		Objects.requireNonNull(after);

		return (t, u, v, w, x, y, z, a, b, c, d, e, f) -> {
			accept(t, u, v, w, x, y, z, a, b, c, d, e, f);
			after.accept(t, u, v, w, x, y, z, a, b, c, d, e, f);
		};
	}
}
